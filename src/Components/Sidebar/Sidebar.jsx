...
export const Sidebar = () => {
    return (
        <div className='sticky top-0 lg:block hidden z-40 left-0 w-[15rem] h-[calc(100vh-56px)] pl-6 bg-black text-white flex-shrink-0 overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-black'>
