...
export const Sidebar = () => {
    return (
        <div className='sticky top-[57px] md:block hidden z-40 left-0 w-[15rem] h-[calc(100vh-56px)] pl-6 text-white overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-black'>
